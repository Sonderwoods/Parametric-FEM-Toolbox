...
{
    public class Component_RFSurface_GUI : GH_SwitcherComponent
    {
        ...
        /// </summary>
        public Component_RFSurface_GUI()
          : base("RF Surface", "RFSurface", "Assembles and Disassembles RFSurface objects.", "B+G Toolbox", "RFEM")
        {
            this.Hidden = (true);
        }

        // Define Keywords to search for this Component more easily in Grasshopper
        public override IEnumerable<string> Keywords => new string[] {"rf", "rfsurface",};
        ...
        {
            subcomponents_.Add(new SubComponent_RFSurface_Assemble_GUI());
            subcomponents_.Add(new SubComponent_RFSurface_Disassemble_GUI());
