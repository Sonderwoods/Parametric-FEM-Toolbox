...
{
    public class Component_RFLineSupport_GUI : GH_SwitcherComponent
    {
        ...
        /// </summary>
        public Component_RFLineSupport_GUI()
          : base("RF Line Support", "RFLineSupport", "Assembles and Disassembles RFLineSupport objects.", "B+G Toolbox", "RFEM")
        {
            this.Hidden = (true);
        }

        // Define Keywords to search for this Component more easily in Grasshopper
        public override IEnumerable<string> Keywords => new string[] {"rf", "rflinesupport",};
        ...
        {
            subcomponents_.Add(new SubComponent_RFLineSupport_Assemble_GUI());
            subcomponents_.Add(new SubComponent_RFLineSupport_Disassemble_GUI());
        ...
        {
            get { return new Guid("11108b1d-98d5-4e24-8f0e-46b86c4b39ad"); }
        }
    }
}
