...
{
    public class Component_RFLoadCombo_GUI : GH_SwitcherComponent
    {
        ...
        /// </summary>
        public Component_RFLoadCombo_GUI()
          : base("RF Load Combination", "RFLoadCombo", "Assembles and Disassembles RFLoadCombo objects.", "B+G Toolbox", "RFEM")
        {
            this.Hidden = (true);
        }

        // Define Keywords to search for this Component more easily in Grasshopper
        public override IEnumerable<string> Keywords => new string[] {"rf", "rfloadcombo", "load", "combo", "combination" };
        ...
        {
            subcomponents_.Add(new SubComponent_RFLoadCombo_Assemble_GUI());
            subcomponents_.Add(new SubComponent_RFLoadCombo_Disassemble_GUI());
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return Properties.Resources.Assemble_LoadCombo;                
            }
        }
        ...
        {
            get { return new Guid("294eaba8-37bb-4172-a234-10d7c1193511"); }
        }
    }
}
