...
{
    public class Component_RFMemberLoad_GUI : GH_SwitcherComponent
    {
        ...
        /// </summary>
        public Component_RFMemberLoad_GUI()
          : base("RF Member Load", "RFMemberLoad", "Assembles and Disassembles RFMemberLoad objects.", "B+G Toolbox", "RFEM")
        {
            this.Hidden = (true);
        }

        // Define Keywords to search for this Component more easily in Grasshopper
        public override IEnumerable<string> Keywords => new string[] {"rf", "rfmemberload", "load", "member" };
        ...
        {
            subcomponents_.Add(new SubComponent_RFMemberLoad_Assemble_GUI());
            subcomponents_.Add(new SubComponent_RFMemberLoad_Disassemble_GUI());
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return Properties.Resources.Assemble_MemberLoad;                
            }
        }
        ...
        {
            get { return new Guid("f3ed8bc7-676b-483d-a298-44e3abf54848"); }
        }
    }
}
