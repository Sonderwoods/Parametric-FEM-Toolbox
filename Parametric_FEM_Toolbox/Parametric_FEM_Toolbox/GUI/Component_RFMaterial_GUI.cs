...
{
    public class Component_RFMaterial_GUI : GH_SwitcherComponent
    {
        ...
        /// </summary>
        public Component_RFMaterial_GUI()
          : base("RF Material", "RFMaterial", "Assembles and Disassembles RFMaterial objects.", "B+G Toolbox", "RFEM")
        {
            this.Hidden = (true);
        }

        // Define Keywords to search for this Component more easily in Grasshopper
        public override IEnumerable<string> Keywords => new string[] {"rf", "rfmaterial",};
        ...
        {
            get { return new Guid("db308f8b-afe2-4316-8400-48f2c3192e4f"); }
        }
    }
}
