...
{
    public class Component_RFNodalLoad_GUI : GH_SwitcherComponent
    {
        ...
        /// </summary>
        public Component_RFNodalLoad_GUI()
          : base("RF Nodal Load", "RFNodLoad", "Assembles and Disassembles RFNodalLoad objects.", "B+G Toolbox", "RFEM")
        {
            this.Hidden = (true);
        }
        ...
        {
            subcomponents_.Add(new SubComponent_RFNodalLoad_Assemble_GUI());
            subcomponents_.Add(new SubComponent_RFNodalLoad_Disassemble_GUI());
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return Properties.Resources.Assemble_NodalLoad;                
            }
        }
        ...
        {
            get { return new Guid("2a26ffab-da30-4078-b2ed-26f42a149b59"); }
        }
    }
}
