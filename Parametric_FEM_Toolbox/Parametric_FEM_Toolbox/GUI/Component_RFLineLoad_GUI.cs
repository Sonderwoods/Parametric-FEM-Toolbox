...
{
    public class Component_RFLineLoad_GUI : GH_SwitcherComponent
    {
        ...
        /// </summary>
        public Component_RFLineLoad_GUI()
          : base("RF Line Load", "RFLineLoad", "Assembles and Disassembles RFLineLoad objects.", "B+G Toolbox", "RFEM")
        {
            this.Hidden = (true);
        }

        // Define Keywords to search for this Component more easily in Grasshopper
        public override IEnumerable<string> Keywords => new string[] {"rf", "rflineload", "load", "line" };
        ...
        {
            subcomponents_.Add(new SubComponent_RFLineLoad_Assemble_GUI());
            subcomponents_.Add(new SubComponent_RFLineLoad_Disassemble_GUI());
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return Properties.Resources.Assemble_LineLoad;                
            }
        }
        ...
        {
            get { return new Guid("ddce5689-5bcf-4db3-b845-37fc60458f4d"); }
        }
    }
}
