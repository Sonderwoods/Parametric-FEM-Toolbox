...
{
    public class Component_RFSrfcSupport_GUI : GH_SwitcherComponent
    {
        ...
        /// </summary>
        public Component_RFSrfcSupport_GUI()
          : base("RF Surface Support", "RFSrfcSupport", "Assembles and Disassembles RFSrfcSupport objects.", "B+G Toolbox", "RFEM")
        {
            this.Hidden = (true);
        }

        // Define Keywords to search for this Component more easily in Grasshopper
        public override IEnumerable<string> Keywords => new string[] {"rf", "rfsrfcsupport",};
        ...
        {
            subcomponents_.Add(new SubComponent_RFSrfcSupport_Assemble_GUI());
            subcomponents_.Add(new SubComponent_RFSrfcSupport_Disassemble_GUI());
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return Properties.Resources.Assemble_SupportS;                
            }
        }
        ...
        {
            get { return new Guid("a4d98037-b835-4299-a809-afddf0de139e"); }
        }
    }
}
