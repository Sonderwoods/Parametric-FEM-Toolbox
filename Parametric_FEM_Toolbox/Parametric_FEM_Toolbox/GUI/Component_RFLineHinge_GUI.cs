...
{
    public class Component_RFLineHinge_GUI : GH_SwitcherComponent
    {
        ...
        /// </summary>
        public Component_RFLineHinge_GUI()
          : base("RF Line Hinge", "RFLineHinge", "Assembles and Disassembles RFLineHinge objects.", "B+G Toolbox", "RFEM")
        {
            this.Hidden = (true);
        }

        // Define Keywords to search for this Component more easily in Grasshopper
        public override IEnumerable<string> Keywords => new string[] {"rf", "rflinehinge",};
        ...
        {
            subcomponents_.Add(new SubComponent_RFLineHinge_Assemble_GUI());
            subcomponents_.Add(new SubComponent_RFLineHinge_Disassemble_GUI());
        ...
        {
            get { return new Guid("60b48a1b-7127-4fe2-b7b5-f56c1755a7aa"); }
        }
    }
}
