...
{
    public class Component_RFResultCombo_GUI : GH_SwitcherComponent
    {
        ...
        /// </summary>
        public Component_RFResultCombo_GUI()
          : base("RF Result Combination", "RFResultCombo", "Assembles and Disassembles RFResultCombo objects.", "B+G Toolbox", "RFEM")
        {
            this.Hidden = (true);
        }

        // Define Keywords to search for this Component more easily in Grasshopper
        public override IEnumerable<string> Keywords => new string[] {"rf", "rfresultcombo", "load", "combo", "result" };
        ...
        {
            subcomponents_.Add(new SubComponent_RFResultCombo_Assemble_GUI());
            subcomponents_.Add(new SubComponent_RFResultCombo_Disassemble_GUI());
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return Properties.Resources.Assemble_ResultCombination;                
            }
        }
        ...
        {
            get { return new Guid("82f6a56b-dc37-47ac-9f66-5e078777baf9"); }
        }
    }
}
