...
{
    public class Component_RFLoadCase_GUI : GH_SwitcherComponent
    {
        ...
        /// </summary>
        public Component_RFLoadCase_GUI()
          : base("RF Load Case", "RFLoadCase", "Assembles and Disassembles RFLoadCase objects.", "B+G Toolbox", "RFEM")
        {
            this.Hidden = (true);
        }

        // Define Keywords to search for this Component more easily in Grasshopper
        public override IEnumerable<string> Keywords => new string[] {"rf", "rfloadcase", "load", "case"};
        ...
        {
            subcomponents_.Add(new SubComponent_RFLoadCase_Assemble_GUI());
            subcomponents_.Add(new SubComponent_RFLoadCase_Disassemble_GUI());
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return Properties.Resources.Assemble_LoadCase;                
            }
        }
        ...
        {
            get { return new Guid("bd88d372-b3ea-4336-8a8b-bc115a6eb710"); }
        }
    }
}
