...
{
    public class Component_RFOpening_GUI : GH_SwitcherComponent
    {
        ...
        /// </summary>
        public Component_RFOpening_GUI()
          : base("RF Opening", "RFOpening", "Assembles and Disassembles RFOpening objects.", "B+G Toolbox", "RFEM")
        {
            this.Hidden = (true);
        }

        // Define Keywords to search for this Component more easily in Grasshopper
        public override IEnumerable<string> Keywords => new string[] {"rf", "rfopening",};
        ...
        {
            subcomponents_.Add(new SubComponent_RFOpening_Assemble_GUI());
            subcomponents_.Add(new SubComponent_RFOpening_Disassemble_GUI());
        ...
        {
            get { return new Guid("277ddc7f-bf67-4a37-aefa-8bf6c2ab8a3f"); }
        }
    }
}
