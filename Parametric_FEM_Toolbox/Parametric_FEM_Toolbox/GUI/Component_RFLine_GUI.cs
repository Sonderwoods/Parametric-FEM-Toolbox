...
{
    public class Component_RFLine_GUI : GH_SwitcherComponent
    {
        ...
        /// </summary>
        public Component_RFLine_GUI()
          : base("RF Line", "RFLine", "Assembles and Disassembles RFLine objects.", "B+G Toolbox", "RFEM")
        {
            this.Hidden = (true);
        }

        // Define Keywords to search for this Component more easily in Grasshopper
        public override IEnumerable<string> Keywords => new string[] {"rf", "rfline",};
        ...
        {
            subcomponents_.Add(new SubComponent_RFLine_Assemble_GUI());
            subcomponents_.Add(new SubComponent_RFLine_Disassemble_GUI());
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return Properties.Resources.Assemble_Line;                
            }
        }
        ...
        {
            get { return new Guid("a1335c40-5283-411f-9367-70a21d63007d"); }
        }
    }
}
