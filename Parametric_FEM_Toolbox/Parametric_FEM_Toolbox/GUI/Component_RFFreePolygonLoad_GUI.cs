...
{
    public class Component_RFFreePolygonLoad_GUI : GH_SwitcherComponent
    {
        ...
        /// </summary>
        public Component_RFFreePolygonLoad_GUI()
          : base("RF Free Polygon Load", "RFPolyLoad", "Assembles and Disassembles RFFreePolygonLoad objects.", "B+G Toolbox", "RFEM")
        {
            this.Hidden = (true);
        }

        // Define Keywords to search for this Component more easily in Grasshopper
        public override IEnumerable<string> Keywords => new string[] {"rf", "rfpolyload", "load", "polygon", "free" };
        ...
        {
            subcomponents_.Add(new SubComponent_RFFreePolygonLoad_Assemble_GUI());
            subcomponents_.Add(new SubComponent_RFFreePolygonLoad_Disassemble_GUI());
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return Properties.Resources.Assemble_PolyLoad;                
            }
        }
        ...
        {
            get { return new Guid("98cc35d5-5fc9-4aea-b46e-883a69bc106d"); }
        }
    }
}
