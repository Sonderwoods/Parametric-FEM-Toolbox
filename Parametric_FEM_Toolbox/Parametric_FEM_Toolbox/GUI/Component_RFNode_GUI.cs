...
{
    public class Component_RFNode_GUI : GH_SwitcherComponent
    {
        ...
        /// </summary>
        public Component_RFNode_GUI()
          : base("RF Node", "RFNode", "Assembles and Disassembles RFNode objects.", "B+G Toolbox", "RFEM")
        {
            this.Hidden = (true);
        }

        // Define Keywords to search for this Component more easily in Grasshopper
        public override IEnumerable<string> Keywords => new string[] {"rf", "rfnode",};
        ...
        {
            subcomponents_.Add(new SubComponent_RFNode_Assemble_GUI());
            subcomponents_.Add(new SubComponent_RFNode_Disassemble_GUI());
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return Properties.Resources.Assemble_Node;                
            }
        }
        ...
        {
            get { return new Guid("aa24cb32-281a-4de1-a454-b515821057b5"); }
        }
    }
}
