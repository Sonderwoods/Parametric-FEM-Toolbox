...
{
    public class Component_RFNodalSupport_GUI : GH_SwitcherComponent
    {
        ...
        /// </summary>
        public Component_RFNodalSupport_GUI()
          : base("RF Nodal Support", "RFNodalSupport", "Assembles and Disassembles RFNodalSupport objects.", "B+G Toolbox", "RFEM")
        {
            this.Hidden = (true);
        }

        // Define Keywords to search for this Component more easily in Grasshopper
        public override IEnumerable<string> Keywords => new string[] {"rf", "rfnodalsupport",};
        ...
        {
            subcomponents_.Add(new SubComponent_RFNodalSupport_Assemble_GUI());
            subcomponents_.Add(new SubComponent_RFNodalSupport_Disassemble_GUI());
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return Properties.Resources.Assemble_SupportP;                
            }
        }
