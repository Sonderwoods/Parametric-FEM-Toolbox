...
{
    public class Component_RFMember_GUI_OBSOLETE_3 : GH_SwitcherComponent
    {
        ...
        /// </summary>
        public Component_RFMember_GUI_OBSOLETE_3()
          : base("RF Member", "RFMember", "Assembles and Disassembles RFMember objects.", "B+G Toolbox", "RFEM")
        {
            this.Hidden = (true);
        }

        // Define Keywords to search for this Component more easily in Grasshopper
        public override IEnumerable<string> Keywords => new string[] {"rf", "rfmember",};
        ...
        {
            subcomponents_.Add(new SubComponent_RFMember_Assemble_GUI_OBSOLETE());
            subcomponents_.Add(new SubComponent_RFMember_Disassemble_GUI_OBSOLETE_2());
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return Properties.Resources.Assemble_Member;                
            }
        }
        ...
        {
            get { return new Guid("86eaa2d7-b2c8-4c13-9ceb-9ed5fc17e9c3"); }
        }
    }
}
