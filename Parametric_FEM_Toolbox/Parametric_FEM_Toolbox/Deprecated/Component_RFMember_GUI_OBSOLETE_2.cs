...
{
    public class Component_RFMember_GUI_OBSOLETE_2 : GH_SwitcherComponent
    {
        ...
        /// </summary>
        public Component_RFMember_GUI_OBSOLETE_2()
        ...
        {
            subcomponents_.Add(new SubComponent_RFMember_Assemble_GUI());
            subcomponents_.Add(new SubComponent_RFMember_Disassemble_GUI_OBSOLETE());
        ...
        {
            get { return new Guid("5ed02d3b-b0f0-4399-99f4-c7b0b4f5376b"); }
        }
    }
}
